...
contract PoolController is Modifiers, IERC721Receiver {
        ...
        returns (uint256 tokenId, uint128 liquidity, uint256 amount0, uint256 amount1)
    {
        ...
        TransferHelper.safeApprove(token0, address(Constants.NON_FUNGIBLE_POSITION_MANAGER), amount0ToMint + premium);
        TransferHelper.safeApprove(token1, address(Constants.NON_FUNGIBLE_POSITION_MANAGER), amount1ToMint + premium);
